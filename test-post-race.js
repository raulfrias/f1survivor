...
class PostRaceTestSuite {
    ...
    async testRaceResultsAPI() {
        ...
        try {
            ...
            const { fetchRaceResults, calculateSurvivalStatus } = await import('./race-results-api.js');
    ...
    async testSurvivalCalculations() {
        ...
        try {
            const { calculateSurvivalStatus, isPlayerAlive, calculateSurvivalRate, getPicksWithResults } = await import('./race-results-api.js');
    ...
    async testRaceTransitions() {
        ...
        try {
            ...
            const { getNextRace, F1_2025_CALENDAR } = await import('./race-calendar-2025.js');
    ...
    async testSystemReset() {
        ...
        try {
            ...
            const { getDashboardData, calculateDashboardStats } = await import('./dashboard-utils.js');
